...
<ul class="nav-list flex lg:hidden flex-col">
    ...
    <li><a class="nav-link" href="<?php echo home_url('/history/'); ?>"><div class="text">会社の歴史</div></a></li>
    <li><a class="nav-link" href="<?php echo home_url('/company/'); ?>"><div class="text">会社案内</div></a></li>
    <li><a class="nav-link" href="<?php echo home_url('/for-indiv/'); ?>"><div class="text">個人のお客さま</div></a></li>
    <li><a class="nav-link" href="<?php echo home_url('/for-corp/'); ?>"><div class="text">法人のお客さま</div></a></li>
    <li class="js-sub-menu">
        <a class="js-sub-menu__toggle nav-link" href="<?php echo home_url('/for-group/'); ?>"><div class="text">団体のお客さま</div></a>
        <div class="js-sub-menu__wrap lg:bg-white/90 border-green">
            <ul class="nav-list--sub">
                <li><a class="nav-link" href="<?php echo home_url('/for-group/okayama-u/'); ?>"><div class="text">岡山大学会員さま専用サイト</div></a></li>
                <li><a class="nav-link" href="<?php echo home_url('/for-group/dental/'); ?>"><div class="text">歯科医師会会員さま専用サイト</div></a></li>
                <li><a class="nav-link" href="<?php echo home_url('/for-group/kensikai/'); ?>"><div class="text">けんし会会員さま専用サイト</div></a></li>
            </ul>
        </div>
    </li>
